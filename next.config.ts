...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      `img-src 'self' data: blob: https://*.stripe.com https://static.parisfashionshops.com https://cdn.parisfashionshops.com https://wapi.efashion-paris.com ${process.env.R2_PUBLIC_URL || process.env.NEXT_PUBLIC_R2_URL || ""}`,
      "font-src 'self'",
