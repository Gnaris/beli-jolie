...
export default function CreateSizeTrigger() {
  return (
    <button
      type="button"
      onClick={() => document.querySelector<HTMLButtonElement>("[data-trigger-create-size]")?.click()}
    ...
    >
      <span className="text-base leading-none">+</span> Nouvelle taille
    </button>
  );
}
