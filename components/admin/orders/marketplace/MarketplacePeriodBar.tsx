...
import type { MarketplacePeriodKey } from "@/app/actions/admin/marketplace-orders";

const OPTIONS: Array<{ key: MarketplacePeriodKey; label: string }> = [
...
interface Props {
  value: MarketplacePeriodKey;
  onChange: (v: MarketplacePeriodKey) => void;
  customFrom: string;
  customTo: string;
...
export default function MarketplacePeriodBar({
  value,
  onChange,
  customFrom,
  customTo,
