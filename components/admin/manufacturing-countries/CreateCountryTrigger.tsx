...
export default function CreateCountryTrigger() {
  return (
    <button
      type="button"
      onClick={() => document.querySelector<HTMLButtonElement>("[data-trigger-create-country]")?.click()}
    ...
    >
      <span className="text-base leading-none">+</span> Nouveau pays
    </button>
  );
}
