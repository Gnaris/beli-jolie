 ...
 * sauvegarde SMTP. La cliente doit ensuite copier 4 records DNS chez son
 * propre registrar pour que le mail soit accepté par Gmail/Outlook.
 */
  ...
  if (result?.ok) {
    return (
      <div className="space-y-4">
        ...
        {result.dnsRecap && (
          <details className="rounded-2xl border border-border bg-bg-secondary/40 p-4" open>
            <summary className="cursor-pointer text-sm font-semibold text-text-primary">
              🔧 Réglages à ajouter chez l&apos;endroit où vous avez acheté votre domaine
            </summary>
            <p className="text-xs text-text-secondary my-3">
              Copiez ces lignes dans la page DNS de votre domaine (chez
              Hostinger, OVH, Gandi, etc.). Elles permettent au mail
              d&apos;arriver et d&apos;être accepté par Gmail / Outlook. Une
              fois posées, comptez 1 à 24 h avant que ça marche.
            </p>
