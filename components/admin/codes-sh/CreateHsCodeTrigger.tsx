...
export default function CreateHsCodeTrigger() {
  return (
    <button
      type="button"
      onClick={() => document.querySelector<HTMLButtonElement>("[data-trigger-create-hscode]")?.click()}
    ...
    >
      <span className="text-base leading-none">+</span> Nouveau code SH
    </button>
  );
}
