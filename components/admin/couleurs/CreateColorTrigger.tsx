...
export default function CreateColorTrigger() {
  return (
    <button
      type="button"
      onClick={() => document.querySelector<HTMLButtonElement>("[data-trigger-create-color]")?.click()}
    ...
    >
      <span className="text-base leading-none">+</span> Nouvelle couleur
    </button>
  );
}
