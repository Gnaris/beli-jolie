...
const NAV_SECTIONS: { title: string; items: { label: string; href: string; icon: string; soon?: boolean }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Ankorstore", href: "/admin/ankorstore", icon: "M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" },
    ],
  },
  {
    title: "Ventes",
    items: [
      ...
      { label: "Reclamations", href: "/admin/reclamations", icon: "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" },
