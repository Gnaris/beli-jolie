...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Mapping PFS", href: "/admin/pfs/mapping", icon: "M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.556a4.5 4.5 0 00-1.242-7.244l4.5-4.5a4.5 4.5 0 016.364 6.364l-1.757 1.757" },
    ],
  },
  {
    title: "Attributs",
