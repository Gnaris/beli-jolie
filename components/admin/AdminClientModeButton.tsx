...
export default function AdminClientModeButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={pending}
      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-body text-[#4B5563] hover:text-[#1F2937] hover:bg-gray-50 rounded-lg transition-colors group"
    >
