...
type Marketplace = "pfs" | "efashion" | "faire" | "orderchamp";
...
export default function MarketplaceMappingCards({ pfsLabel, efashionLabel, faireLabel, orderchampLabel, onEditMapping }: Props) {
      ...
      {ITEMS.map((m) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`text-[12.5px] leading-snug min-h-[18px] ${
