...
export default function CategoryTranslationsLocked({ translations }: Props) {
  return (
      ...
      {LANGS.map(({ code, label }) => {
        ...
        return (
          ...
          >
            ...
            <svg className="w-3.5 h-3.5 text-text-muted/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
