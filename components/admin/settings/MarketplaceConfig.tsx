...
// ─── Slide-over drawer (pleine hauteur, ancré à droite, 520 px) ──────────────
  ...
  return (
    <div className="fixed inset-0 z-[60]">
      <div
        ...
        onClick={onClose}
      />
      <div className="absolute top-0 right-0 h-full w-full sm:max-w-[520px] bg-bg-primary shadow-2xl flex flex-col animate-[slideInRight_240ms_cubic-bezier(0.16,1,0.3,1)]">
        <div
