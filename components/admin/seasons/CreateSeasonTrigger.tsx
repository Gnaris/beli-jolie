...
export default function CreateSeasonTrigger() {
  return (
    <button
      type="button"
      onClick={() => document.querySelector<HTMLButtonElement>("[data-trigger-create-season]")?.click()}
    ...
    >
      <span className="text-base leading-none">+</span> Nouvelle saison
    </button>
  );
}
