    ...
    <div className="flex flex-col gap-3 md:gap-4 p-3 md:p-7 bg-bg-primary overflow-y-auto md:h-full">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 md:gap-4 min-w-0 flex-1">
            ...
            <div className="relative shrink-0">
              <span
                aria-hidden
                className="w-14 h-14 md:w-[72px] md:h-[72px] rounded-2xl md:rounded-[20px] inline-flex items-center justify-center text-[26px] md:text-[34px]"
                style={chipStyle}
              >
                {emoji}
              </span>
            ...
            <div className="min-w-0">
              <h2 className="text-[19px] md:text-[22px] font-bold tracking-tight text-text-primary truncate font-heading">
                {season.name}
              </h2>
              <div className="flex items-center gap-2 md:gap-2.5 text-[11.5px] md:text-[12px] text-text-secondary mt-1 md:mt-1.5 flex-wrap">
                ...
                <span className="hidden md:inline">créée le {formatDate(season.createdAt)}</span>
              </div>
            </div>
          </div>
          {/* Actions desktop */}
      ...
      <section className="relative bg-bg-primary border border-border rounded-2xl p-3 md:p-4 shadow-[var(--shadow-sm)] overflow-hidden">
        ...
        <SeasonMarketplaceMappingCards
          ...
          microstoreLabel={season.microstoreLabel}
