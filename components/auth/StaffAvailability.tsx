...
/**
 * Affiche un message dynamique selon les horaires du staff (9h-22h heure de Paris).
 * variant="dark" pour le panneau sombre du layout auth.
 */
export default function StaffAvailability({ variant = "light" }: { variant?: "light" | "dark" }) {
