...
export const COUNTRIES: readonly CountryOption[] = [
  { code: "FR", name: "France", nameEn: "France", efashionProvenanceId: 2, faireCountryCode: "FRA" },
  ...
  { code: "IT", name: "Italie", nameEn: "Italy", efashionProvenanceId: 3, faireCountryCode: "ITA" },
  { code: "PT", name: "Portugal", nameEn: "Portugal", efashionProvenanceId: 19, faireCountryCode: "PRT" },
  { code: "NL", name: "Pays-Bas", nameEn: "Netherlands", efashionProvenanceId: 25, faireCountryCode: "NLD" },
  { code: "GB", name: "Royaume-Uni", nameEn: "United Kingdom", efashionProvenanceId: 8, faireCountryCode: "GBR" },
  ...
  { code: "PL", name: "Pologne", nameEn: "Poland", efashionProvenanceId: 18, faireCountryCode: "POL" },
  ...
  { code: "BG", name: "Bulgarie", nameEn: "Bulgaria", efashionProvenanceId: 11 },
  { code: "GR", name: "Grèce", nameEn: "Greece", efashionProvenanceId: 17, faireCountryCode: "GRC" },
  { code: "HR", name: "Croatie", nameEn: "Croatia" },
  { code: "SI", name: "Slovénie", nameEn: "Slovenia" },
  { code: "EE", name: "Estonie", nameEn: "Estonia" },
  { code: "LV", name: "Lettonie", nameEn: "Latvia", efashionProvenanceId: 10 },
  ...
  { code: "MA", name: "Maroc", nameEn: "Morocco", efashionProvenanceId: 14, faireCountryCode: "MAR" },
  { code: "DZ", name: "Algérie", nameEn: "Algeria" },
  { code: "TN", name: "Tunisie", nameEn: "Tunisia", efashionProvenanceId: 27, faireCountryCode: "TUN" },
  ...
  { code: "TR", name: "Turquie", nameEn: "Turkey", efashionProvenanceId: 7, faireCountryCode: "TUR" },
  { code: "IL", name: "Israël", nameEn: "Israel", faireCountryCode: "ISR" },
  // eFashion appelle cette provenance "Dubaï" (id 23), mais côté BJ on garde le pays AE.
  { code: "AE", name: "Émirats arabes unis", nameEn: "United Arab Emirates", efashionProvenanceId: 23, faireCountryCode: "ARE" },
  { code: "SA", name: "Arabie saoudite", nameEn: "Saudi Arabia" },
  { code: "QA", name: "Qatar", nameEn: "Qatar" },
  { code: "LB", name: "Liban", nameEn: "Lebanon", efashionProvenanceId: 20 },
  { code: "SY", name: "Syrie", nameEn: "Syria", efashionProvenanceId: 26 },
  { code: "JO", name: "Jordanie", nameEn: "Jordan" },
  { code: "IN", name: "Inde", nameEn: "India", efashionProvenanceId: 9, faireCountryCode: "IND" },
  { code: "NP", name: "Népal", nameEn: "Nepal", efashionProvenanceId: 12 },
  {
    code: "CN",
    name: "Chine",
    nameEn: "China",
  ...
  { code: "MN", name: "Mongolie", nameEn: "Mongolia", efashionProvenanceId: 13 },
  ...
  { code: "VN", name: "Vietnam", nameEn: "Vietnam", efashionProvenanceId: 21, faireCountryCode: "VNM" },
  { code: "KH", name: "Cambodge", nameEn: "Cambodia", efashionProvenanceId: 4 },
  ...
  { code: "UA", name: "Ukraine", nameEn: "Ukraine", efashionProvenanceId: 5 },
  { code: "RS", name: "Serbie", nameEn: "Serbia" },
  { code: "BA", name: "Bosnie-Herzégovine", nameEn: "Bosnia and Herzegovina" },
  { code: "AL", name: "Albanie", nameEn: "Albania", efashionProvenanceId: 22 },
  ...
  { code: "BD", name: "Bangladesh", nameEn: "Bangladesh", efashionProvenanceId: 6, faireCountryCode: "BGD" },
  { code: "PK", name: "Pakistan", nameEn: "Pakistan", efashionProvenanceId: 16, faireCountryCode: "PAK" },
  ...
  { code: "MG", name: "Madagascar", nameEn: "Madagascar", efashionProvenanceId: 15 },
