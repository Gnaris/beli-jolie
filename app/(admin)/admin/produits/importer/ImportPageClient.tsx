...
export default function ImportPageClient({ hasPfsConfig, efashionEnabled, ankorstoreEnabled }: { hasPfsConfig: boolean; efashionEnabled: boolean; ankorstoreEnabled: boolean }) {
          ...
          {efashionEnabled ? (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-medium text-sm text-text-primary font-body">eFashion Paris</span>
              </div>
          ...
          {ankorstoreEnabled ? (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-medium text-sm text-text-primary font-body">Ankorstore</span>
              </div>
