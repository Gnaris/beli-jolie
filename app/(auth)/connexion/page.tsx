  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="mb-8 text-center">
        <div className="inline-flex items-center gap-2 bg-bg-dark text-text-inverse text-xs font-[family-name:var(--font-roboto)] font-semibold px-4 py-1.5 rounded-full mb-5 uppercase tracking-wider">
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          </svg>
          Espace B2B
        </div>
        <h2 className="font-[family-name:var(--font-poppins)] text-lg font-semibold text-text-primary mb-2">
          Boutique réservée aux professionnels
        </h2>
        <p className="text-sm text-text-muted font-[family-name:var(--font-roboto)] leading-relaxed max-w-sm mx-auto">
      ...
      <p className="text-center mt-6">
        <a
          href="/inscription"
          className="inline-flex items-center gap-1.5 text-sm font-medium text-text-primary font-[family-name:var(--font-roboto)] hover:underline transition-colors"
        >
